...
function Earbuds() {
    ...
    useEffect(() => {
        if (filter !== null && sort !== null) {
            dispatch(fetchAllFilterProducts({ filterParams: { ...filter, category: 'earbuds' }, sortParams: sort }));
        }
                        ...
                        <div className="grid grid-cols-3 items-center">
                            ...
                            <div className="flex justify-center items-center">
                                <h2 className="text-lg font-extrabold text-white hidden md:block">
                                    {searchQuery ? `Search results for "${searchQuery}"` : "Earbuds"}
                                </h2>
                        ...
                        {isSearching ? (
                            ...
                            (productsToDisplay.length > 0) ? (
                                ...
                                <div className="col-span-full text-center py-10 text-white">
                                    {searchQuery ? (
                                        <>
                                            <p className="text-xl mb-2">No earbuds match "{searchQuery}"</p>
                                            <p className="text-gray-400 mb-6">Try using different keywords or checking your spelling</p>
                                        </>
                                    ) : (
                                        <p>No earbuds found. Try adjusting your filters.</p>
                                    )}
